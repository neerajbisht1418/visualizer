...
function useThreeScene(
  ...
  useEffect(() => {
    if (scene && renderer && camera) {
      loadModel(
        "/lungi/without_shirt/DSC_0784/DSC_0784_LUNGI.glb",
      ...
      loadModel(
        "/lungi/without_shirt/DSC_0784/DSC_0784_TOWEL.glb",
      ...
      loadModel(
        "/lungi/without_shirt/DSC_0784/DSC_0784_BODY.glb",
        "/lungi/without_shirt/DSC_0784/DSC_0784_BODY.png",
        {
          x: 0,
          y: -0.3,
          z: -2
