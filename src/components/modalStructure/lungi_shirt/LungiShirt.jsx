...
function useThreeScene(
  ...
  const loadModel = (modelUrl, textureUrl, position, scale, rotate, shadow) => {
  ...
  useEffect(() => {
    if (scene && renderer && camera) {
      loadModel(
        "/lungi/with_shirt/DSC_0793/DSC_0793_LUNGI.glb",
      ...
      loadModel(
        "/lungi/with_shirt/DSC_0793/DSC_0793_SHIRT.glb",
        "/shirt_textures/3.jpg",
        {
          x: 0,
          y: -0.3,
      ...
      loadModel(
        "/lungi/with_shirt/DSC_0793/DSC_0793_BODY.glb",
        "/lungi/with_shirt/DSC_0793/DSC_0793_SHADOWS.png",
        {
          x: 0,
          y: -0.3,
          z: -3
      ...
      loadModel(
        "/lungi/with_shirt/DSC_0793/DSC_0793_BODY.glb",
        "/lungi/with_shirt/DSC_0793/DSC_0793_BODY.png",
        {
          x: 0,
          y: -0.3,
          z: -2
